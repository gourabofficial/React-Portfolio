  ...
  return (
    <div className="flex flex-col md:flex-row w-full justify-between items-center p-10 md:p-20 text-white fade-in-animation">
      <div className="md:w-2/4 md:pt-10">
        ...
        <button
          className="ripple mt-5 md:mt-10 text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 
      ...
      <div className="mt-10 md:mt-0">
        <img
          className="w-40 hover:scale-105 transition duration-300 ease-in-out md:w-80 md:h-80 rounded-xl object-cover shadow-lg bounce-animation"
